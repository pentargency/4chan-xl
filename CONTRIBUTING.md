...
Bug reports and feature requests for 4chan XL are tracked at **https://github.com/pentargency/4chan-xl/issues?q=is%3Aopen+sort%3Aupdated-desc**.
...
2. Make sure your browser, 4chan XL, and userscript manager (e.g. Greasemonkey, ViolentMoney, or Tampermonkey) are up to date. **Include the versions you're using in bug reports.**
...
7. Test if the bug occurs using the **native extension** with 4chan XL disabled. If it does, it's likely a problem with 4chan or your browser rather than with 4chan XL.
...
- Clone 4chan XL: `git clone https://github.com/pentargency/4chan-xl.git`<br>(If this is taking too long, you can add `--depth 100` to fetch only recent history.)
- Open the directory: `cd 4chan-xl`
...
- 4chan XL is mostly written in [CoffeeScript](http://coffeescript.org/). If you're already familiar with Javascript, it doesn't take long to pick up.
...
4chan XL updates from there automatically.

### More info

Further documentation is available at https://github.com/pentargency/4chan-xl/wiki/Developer-Documentation.
